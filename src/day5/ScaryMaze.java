...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor == -16076800 ) {
	      JOptionPane.showInputDialog("You Win!"); }
	}

	private void scare(String string) {
	...
	private void scare() {
		...
		//AudioClip sound = JApplet.newAudioClip(getClass().getResource("325113_fisch12345_error.wav"));
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("325113__fisch12345__error.wav"));
